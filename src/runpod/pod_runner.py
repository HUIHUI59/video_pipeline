    ...
    for e in todo:
        ...
        for r2_p in r2_persons:
            ...
            r1_person_text = (
                ...
                "('static', 'tracking', 'pan', 'handheld', 'steady', "
                "'zoom', 'close-up' etc.) — those describe the CAMERA, "
                "not the person's action.\n"
                "      tempo: free-form describing BODY pacing (e.g. "
                "'slow', 'moderate', 'fast', 'rapid', 'pausing', "
                "'sustained-flow'). SAME BAN on camera terms — if the "
                "person is motionless, use 'slow' or 'minimal' or null, "
                "NOT 'static'.\n"
                ...
                "  - gesture_detail: REQUIRED concrete description of "
                "hand/arm posture and motion. Must specify WHICH hand "
                "(left/right/both) and WHAT it's doing (pointing, "
                "holding, gesturing toward X, resting on Y, etc.). "
                "When hands_visible=true, a vague value like "
                "'no visible gesture', 'none', 'n/a', 'no gesture' "
                "triggers a validator warning — replace with the "
                "actual resting/idle description such as 'right hand "
                "rests on lap, left hand grips armrest' or 'both hands "
                "hang naturally at the sides'. When hands_visible=false, "
                "null is acceptable.\n"
                "  - hands_visible: bool\n"
